...
function addPatient() {
  ...
  if (name && gender && age && condition) {
    ...
    resetForm();//method to clear the input fields for the next entry
    generateReport();//method to update and display the analysis report based on the newly added patient data
  }
}
...
function generateReport() {
  ...
  const numPatients = patients.length;//Represents the total number of patients stored in the patients[] array
